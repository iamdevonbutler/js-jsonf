 ...
 * @return {String|undefined|[throws]} if `undefined`, assume you provided an invalid type.
 * @api public.
 * @note the order of conditionals takes performance into consideration.
 * e.g. typeof item === 'object' only works properly given the prior conditionals.
 */
