...
// $akey$a$basdfasdfads
self.parse = (str) => {
  var obj = {}, obj1 = {}, len = str.length, i = len, keyBuffer = '', bodyBuffer = '', value, capture = [], stage = 0, state = [], activeState, iOffset;
  while (i--) {
    let skip = false;
    value = str[i];
    // Get key.
